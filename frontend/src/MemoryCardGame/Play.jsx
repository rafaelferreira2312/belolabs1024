...
const playHoverSound = () => {
  if (hoverSound) {
    // Verifique se o usuário já interagiu com a página
    const isUserInteracted = document.body.getAttribute('data-interacted') === 'true';
...
const Play = () => {
  ...
  useEffect(() => {
    ...
    const handleFirstInteraction = () => {
      document.body.setAttribute('data-interacted', 'true');
  ...
  return (
    ...
    >
      ...
      <div className="button-container">
        <button
          className={`playButton ${isCalmMode ? "calm-theme" : "space-theme"}`}
